...
export const fromY = (frame: number, start: number, end: number, amount: number) =>
  interpolate(frame, [start, end], [amount, 0], {...clamp, easing: ease});

export const fromX = (frame: number, start: number, end: number, amount: number) =>
  interpolate(frame, [start, end], [amount, 0], {...clamp, easing: ease});

export const fromScale = (frame: number, start: number, end: number, amount: number) =>
